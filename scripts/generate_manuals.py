...
'camping-checklist': {
 ...
 'steps':['백패킹·오토캠핑·차박캠핑·카라반·모터홈 중 이번 캠핑 유형을 선택합니다.','숙박 수와 함께 준비물을 사용할 전체 인원수를 설정합니다.','다음을 누르고 필요한 준비 카테고리를 켜거나 전체 선택을 사용합니다.','맞춤 체크리스트 만들기를 누른 뒤 카테고리별 추천 품목과 자동 계산된 수량을 확인합니다.','준비한 품목을 체크하고 품목을 눌러 수량·중요도·메모를 수정하거나 새 준비물을 추가합니다.','체크리스트 이름을 정한 뒤 저장을 눌러 현재 기기에 보관하고 최근 목록에서 다시 엽니다.'],
 'output':'캠핑 유형·일정·인원에 맞춘 준비물 목록, 품목별 수량과 중요도, 실시간 준비 완료율 및 개인 메모',
