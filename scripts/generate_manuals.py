...
'camping-checklist': {
 ...
 'steps':['백패킹·오토캠핑·차박캠핑·카라반·모터홈 중 이번 캠핑 유형을 선택합니다.','숙박 수와 함께 준비물을 사용할 전체 인원수를 설정합니다.','다음을 누르고 필요한 준비 카테고리를 켜거나 전체 선택을 사용합니다.','맞춤 체크리스트 만들기를 누르면 추천 품목이 모두 기본 선택된 상태로 생성됩니다.','필요 없는 물품의 체크를 해제하고, 품목을 눌러 수량·중요도·메모를 수정하거나 새 준비물을 추가합니다.','선택한 항목만 PDF 저장 또는 XLSX 저장으로 내려받고, 체크리스트 저장으로 현재 기기에 보관합니다.'],
